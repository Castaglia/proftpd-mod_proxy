...
my $TESTS = {
  ...
  # Normal TimeoutIdle, honored by mod_proxy
  # proxy_gateway_timeout_idle

  # Normal TimeoutNoTransfer, honored by mod_proxy
  # proxy_gateway_timeout_noxfer

  # Normal TimeoutStalled, honored by mod_proxy
...
sub proxy_gateway_retr_largefile {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
