...
INSERT INTO proxy_user_servers (user, url) VALUES ('$setup->{user}', 'ftp://127.0.0.1:$vhost_port2');
  ...
  my $config = {
    ...
    IfModules => {
      ...
      'mod_sql.c' => {
        ...
        SQLNamedQuery => 'get-user-servers SELECT "url FROM proxy_user_servers WHERE user = %{0}"',
      }
    },
